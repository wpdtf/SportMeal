...
partial class FormProduct
{
    ...
    private void InitializeComponent()
    {
        ...
        Count = new Guna2TextBox();
        guna2HtmlLabel2 = new Guna2HtmlLabel();
        Amount = new Guna2TextBox();
        ...
        guna2ControlBox1.Location = new Point(642, 4);
        ...
        guna2ControlBox2.Location = new Point(875, 5);
        ...
        label3.TabIndex = 17;
        label3.Text = "Изменение продуктов";
        // 
        // guna2DragControl1
        // 
        ...
        _btnCancel.Location = new Point(558, 248);
        ...
        _btnRegister.CustomizableEdges = customizableEdges11;
        ...
        _btnRegister.Location = new Point(431, 248);
        _btnRegister.Name = "_btnRegister";
        _btnRegister.ShadowDecoration.CustomizableEdges = customizableEdges12;
        ...
        _Description.CustomizableEdges = customizableEdges13;
        ...
        _Description.ShadowDecoration.CustomizableEdges = customizableEdges14;
        _Description.Size = new Size(407, 145);
        ...
        _Name.CustomizableEdges = customizableEdges15;
        _Name.DefaultText = "";
        ...
        _Name.SelectedText = "";
        _Name.ShadowDecoration.CustomizableEdges = customizableEdges16;
        ...
        guna2HtmlLabel3.Location = new Point(340, 52);
        guna2HtmlLabel3.Name = "guna2HtmlLabel3";
        guna2HtmlLabel3.Size = new Size(81, 17);
        guna2HtmlLabel3.TabIndex = 57;
        guna2HtmlLabel3.Text = "шт. на складе:";
        // 
        // Count
        // 
        Count.BorderRadius = 12;
        Count.Cursor = Cursors.IBeam;
        Count.CustomizableEdges = customizableEdges5;
        Count.DefaultText = "";
        Count.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
        Count.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
        Count.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
        Count.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
        Count.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
        Count.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 204);
        Count.ForeColor = Color.Black;
        Count.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
        Count.Location = new Point(340, 72);
        Count.Name = "Count";
        Count.PlaceholderText = "";
        Count.SelectedText = "";
        Count.ShadowDecoration.CustomizableEdges = customizableEdges6;
        Count.Size = new Size(81, 36);
        Count.TabIndex = 56;
        // 
        // guna2HtmlLabel2
        // 
        ...
        guna2HtmlLabel2.Location = new Point(248, 54);
        guna2HtmlLabel2.Name = "guna2HtmlLabel2";
        guna2HtmlLabel2.Size = new Size(34, 17);
        guna2HtmlLabel2.TabIndex = 55;
        guna2HtmlLabel2.Text = "Цена:";
        // 
        // Amount
        // 
        Amount.BorderRadius = 12;
        Amount.Cursor = Cursors.IBeam;
        Amount.CustomizableEdges = customizableEdges7;
        Amount.DefaultText = "";
        Amount.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
        Amount.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
        Amount.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
        Amount.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
        Amount.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
        Amount.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 204);
        Amount.ForeColor = Color.Black;
        Amount.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
        Amount.Location = new Point(248, 72);
        Amount.Name = "Amount";
        Amount.PlaceholderText = "";
        Amount.SelectedText = "";
        Amount.ShadowDecoration.CustomizableEdges = customizableEdges8;
        Amount.Size = new Size(86, 36);
        Amount.TabIndex = 54;
        // 
        // flowLayoutPanel1
        // 
        ...
        flowLayoutPanel1.Location = new Point(431, 54);
        flowLayoutPanel1.Name = "flowLayoutPanel1";
        flowLayoutPanel1.Size = new Size(227, 180);
